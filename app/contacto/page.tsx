    ...
    <>
      ...
      <div className={style["contact-page-container"]}>
        <div className={style["contact-titles"]}>
          <h2>Contáctanos</h2>
          <p>
            Tu preparación es nuestra prioridad. Estamos disponibles para
        ...
        <div className={style["contact-info"]}>
          <div className={style["contact-text"]}>
            <div className={style["contact-text-subtitle"]}>
              <h4>Simulandum</h4>
              <p>
                Una plataforma comprometida con ayudarte a aprobar tus examenes
                de admision. Responderemos tus consultas en menos de 24 horas
                para garantizar que estés siempre informado.
              </p>
            </div>
            ...
            <div className={style["contact-text-items"]}>
              <div className={style["contact-text-item"]}>
                <Image
                  src="/landing/time.png"
                  alt="Horario"
                  width={26}
                  height={26}
                />
                <p>Lunes a viernes de 10am a 5pm</p>
              </div>

              <div className={style["contact-text-item"]}>
                <Image
                  src="/landing/whatsapp-icon.png"
                  alt="WhatsApp"
                  width={26}
                  height={26}
                />
