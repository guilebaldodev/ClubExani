...
useEffect(() => {
  ...
  const newProgress = {
    _id: crypto.randomUUID(), // un ID temporal
    simulatorId: {
      _id: simulator._id,
  ...
  const newStats = {
    ...
    ((stats?.totalPossible ?? 0) + totalScore) * 100,
  };
      ...
      <div className={style["result-left-footer"]}>
        ...
        <div className={style["results-right"]}>
          ...
          <p>
            ...
            podrás visualizar tu puntaje obtenido, el porcentaje de aciertos y
            una visión general de cómo te fue en esta sesión antes de acceder al
            reporte completo.
          </p>
          ...
          <p className={style["report-p"]}>
            Puedes consultar un reporte más completo de tu desempeño en la
            sección de Resultados, donde encontrarás un análisis detallado de
            cada simulador que has realizado.
          </p>
