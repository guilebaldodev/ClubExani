          ...
          <table>
            <thead>
              <tr>
                ...
                <th>Plan</th>
                <th className={dataStyles["th-center"]}>Edad</th>
                <th className={dataStyles["th-center"]}></th>
              </tr>
            </thead>
            <tbody>
              {/* Aquí puedes repetir las filas de la tabla según sea necesario */}
              <tr>
                <td>1</td>
                ...
                <td className={dataStyles["td-center"]}>
                  <div className={dataStyles['container']}>
                    ...
                    <div className={`${dataStyles['menu']} ${menu ? "" : dataStyles['none']}`}>
                      ...
                      <Link href="#">Ver</Link>
                      <Link href="#">Añadir a examen</Link>
                      <Link href="#">Añadir a cuestionario</Link> */}
                    </div>
                  </div>
                </td>
              </tr>
